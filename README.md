...
Через бот можно менять название, текущую и старую цену, категорию, описание, размеры, цвета, фотографию, остаток, порядок сортировки, видимость и отметку «Новинка».
